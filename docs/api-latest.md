...
<dl>
<dt><a href="#groupedBarChart">groupedBarChart</a> ⇒ <code>dc.barChartGrouped</code></dt>
<dd><p>Concrete grouped bar chart implementation.</p>
</dd>
<dt><a href="#groupedRowChart">groupedRowChart</a> ⇒ <code>dc.rowChartGrouped</code></dt>
<dd><p>Concrete grouped row chart implementation.</p>
</dd>
<dt><a href="#groupedRowChart">groupedRowChart</a> ⇒ <code>dc.rowChartGrouped</code></dt>
<dd><p>Stacked grouped row chart implementation.</p>
</dd>
</dl>
...
<dl>
<dt><a href="#dc">dc</a> : <code>object</code></dt>
<dd><p>The entire dc.js library is scoped under the <strong>dc</strong> name space. It does not introduce
anything else into the global name space.</p>
<p>Most <code>dc</code> functions are designed to allow function chaining, meaning they return the current chart
instance whenever it is appropriate.  The getter forms of functions do not participate in function
chaining because they return values that are not the chart, although some,
such as <a href="#dc.baseMixin+svg">.svg</a> and <a href="#dc.coordinateGridMixin+xAxis">.xAxis</a>,
return values that are themselves chainable d3 objects.</p>
</dd>
</dl>

<a name="groupedBarChart"></a>

## groupedBarChart ⇒ <code>dc.barChartGrouped</code>
...
| --- | --- | --- |
| parent | <code>String</code> \| <code>node</code> \| <code>d3.selection</code> | Any valid |
| [chartGroup] | <code>String</code> | The name of the chart group this chart instance should be placed in. |

<a name="groupedRowChart"></a>

## groupedRowChart ⇒ <code>dc.rowChartGrouped</code>
