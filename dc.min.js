...
d.empty()&&(d=n.svg().append("g").attr("class",c.constants.DEBUG_GROUP_CLASS));var e=d.append("text").attr("x",10).attr("y",20);d.append("rect").attr("width",n.width()).attr("height",n.height()).on("mousemove",function(){var b=a.mouse(d.node()),c=b[0]+", "+b[1];e.text(c)})}else n.selectAll(".debug").remove();return n},n.anchor(b,d),n},c.rowChart=function(b,d){function e(){if(!t||u){var b=a.extent(v,G.cappedValueAccessor);b[0]>0&&(b[0]=0),b[1]<0&&(b[1]=0),t=a.scale.linear().domain(b).range([0,G.effectiveWidth()])}H.scale(t)}function f(){var a=s.select("g.axis");e(),a.empty()&&(a=s.append("g").attr("class","axis")),a.attr("transform","translate(0, "+G.effectiveHeight()+")"),c.transition(a,G.transitionDuration(),G.transitionDelay()).call(H)}function g(){s.selectAll("g.tick").select("line.grid-line").remove(),s.selectAll("g.tick").append("line").attr("class","grid-line").attr("x1",0).attr("y1",0).attr("x2",0).attr("y2",function(){return-G.effectiveHeight()})}function h(){v=G.data(),f(),g();var a=s.selectAll("g."+D).data(v);i(a),j(a),l(a)}function i(a){var b=a.enter().append("g").attr("class",function(a,b){return D+" _"+b});b.append("rect").attr("width",0),n(b)}function j(a){a.exit().remove()}function k(){var a=t(0);return a===-(1/0)||a!==a?t(1):a}function l(a){var b,d=v.length;b=C?C:(G.effectiveHeight()-(d+1)*B)/d,y||(x=b/2);var e=a.attr("transform",function(a,c){return"translate(0,"+((c+1)*B+c*b)+")"}).select("rect").attr("height",b).attr("fill",G.getColor).on("click",p).classed("deselected",function(a){return!!G.hasFilter()&&!r(a)}).classed("selected",function(a){return!!G.hasFilter()&&r(a)});c.transition(e,G.transitionDuration(),G.transitionDelay()).attr("width",function(a){return Math.abs(k()-t(G.valueAccessor()(a)))}).attr("transform",q),m(a),o(a)}function m(a){G.renderTitle()&&(a.select("title").remove(),a.append("title").text(G.title()))}function n(a){G.renderLabel()&&a.append("text").on("click",p),G.renderTitleLabel()&&a.append("text").attr("class",E).on("click",p)}function o(a){if(G.renderLabel()){var b=a.select("text").attr("x",w).attr("y",x).attr("dy",z).on("click",p).attr("class",function(a,b){return D+" _"+b}).text(function(a){return G.label()(a)});c.transition(b,G.transitionDuration(),G.transitionDelay()).attr("transform",q)}if(G.renderTitleLabel()){var d=a.select("."+E).attr("x",G.effectiveWidth()-A).attr("y",x).attr("dy",z).attr("text-anchor","end").on("click",p).attr("class",function(a,b){return E+" _"+b}).text(function(a){return G.title()(a)});c.transition(d,G.transitionDuration(),G.transitionDelay()).attr("transform",q)}}function p(a){G.onClick(a)}function q(a){var b=t(G.cappedValueAccessor(a)),c=k(),d=b>c?c:b;return"translate("+d+",0)"}function r(a){return G.hasFilter(G.cappedKeyAccessor(a))}var s,t,u,v,w=10,x=15,y=!1,z="0.35em",A=2,B=5,C=!1,D="row",E="titlerow",F=!1,G=c.capMixin(c.marginMixin(c.colorMixin(c.baseMixin({})))),H=a.svg.axis().orient("bottom");return G.rowsCap=G.cap,G._doRender=function(){return G.resetSvg(),s=G.svg().append("g").attr("transform","translate("+G.margins().left+","+G.margins().top+")"),h(),G},G.title(function(a){return G.cappedKeyAccessor(a)+": "+G.cappedValueAccessor(a)}),G.label(G.cappedKeyAccessor),G.x=function(a){return arguments.length?(t=a,G):t},G.renderTitleLabel=function(a){return arguments.length?(F=a,G):F},G._doRedraw=function(){return h(),G},G.xAxis=function(){return H},G.fixedBarHeight=function(a){return arguments.length?(C=a,G):C},G.gap=function(a){return arguments.length?(B=a,G):B},G.elasticX=function(a){return arguments.length?(u=a,G):u},G.labelOffsetX=function(a){return arguments.length?(w=a,G):w},G.labelOffsetY=function(a){return arguments.length?(x=a,y=!0,G):x},G.titleLabelOffsetX=function(a){return arguments.length?(A=a,G):A},G.anchor(b,d)},c.legend=function(){function a(){return k+j}var b,d,e,f=2,g={},h=0,i=0,j=12,k=5,l=!1,m=560,n=70,o=!1,p=c.pluck("name");return g.parent=function(a){return arguments.length?(b=a,g):b},g.render=function(){b.svg().select("g.dc-legend").remove(),e=b.svg().append("g").attr("class","dc-legend").attr("transform","translate("+h+","+i+")");var g=b.legendables();void 0!==d&&(g=g.slice(0,d));var q=e.selectAll("g.dc-legend-item").data(g).enter().append("g").attr("class","dc-legend-item").on("mouseover",function(a){b.legendHighlight(a)}).on("mouseout",function(a){b.legendReset(a)}).on("click",function(a){a.chart.legendToggle(a)});e.selectAll("g.dc-legend-item").classed("fadeout",function(a){return a.chart.isLegendableHidden(a)}),g.some(c.pluck("dashstyle"))?q.append("line").attr("x1",0).attr("y1",j/2).attr("x2",j).attr("y2",j/2).attr("stroke-width",2).attr("stroke-dasharray",c.pluck("dashstyle")).attr("stroke",c.pluck("color")):q.append("rect").attr("width",j).attr("height",j).attr("fill",function(a){return a?a.color:"blue"}),q.append("text").text(p).attr("x",j+f).attr("y",function(){return j/2+(this.clientHeight?this.clientHeight:13)/2-2});var r=0,s=0;q.attr("transform",function(b,c){if(l){var d=o===!0?this.getBBox().width+k:n;r+d>m&&r>0&&(++s,r=0);var e="translate("+r+","+s*a()+")";return r+=d,e}return"translate(0,"+c*a()+")"})},g.x=function(a){return arguments.length?(h=a,g):h},g.y=function(a){return arguments.length?(i=a,g):i},g.gap=function(a){return arguments.length?(k=a,g):k},g.itemHeight=function(a){return arguments.length?(j=a,g):j},g.horizontal=function(a){return arguments.length?(l=a,g):l},g.legendWidth=function(a){return arguments.length?(m=a,g):m},g.itemWidth=function(a){return arguments.length?(n=a,g):n},g.autoItemWidth=function(a){return arguments.length?(o=a,g):o},g.legendText=function(a){return arguments.length?(p=a,g):p},g.maxItems=function(a){return arguments.length?(d=c.utils.isNumber(a)?a:void 0,g):d},g},c.scatterPlot=function(b,d){function e(a,b){return j(a)?v[b]?Math.pow(n,2):Math.pow(o,2):Math.pow(r,2)}function f(a,b){h.renderTitle()&&(a.selectAll("title").remove(),a.append("title").text(function(a){return h.title()(a)}))}function g(b,d){var e=h.chartBodyG().selectAll(".chart-body path.symbol").filter(function(){return b(a.select(this))}),f=i.size();i.size(Math.pow(d,2)),c.transition(e,h.transitionDuration(),h.transitionDelay()).attr("d",i),i.size(f)}var h=c.coordinateGridMixin({}),i=a.svg.symbol(),j=function(a){return a.value},k=h.keyAccessor();h.keyAccessor(function(a){return k(a)[0]}),h.valueAccessor(function(a){return k(a)[1]}),h.colorAccessor(function(){return h._groupName}),h.title(function(a){return h.keyAccessor()(a)+","+h.valueAccessor()(a)+": "+h.existenceAccessor()(a)});var l=function(a){return"translate("+h.x()(h.keyAccessor()(a))+","+h.y()(h.valueAccessor()(a))+")"},m=7,n=5,o=3,p=null,q=1,r=0,s=0,t=1,u=null,v=[];return i.size(e),c.override(h,"_filter",function(a){return arguments.length?h.__filter(c.filters.RangedTwoDimensionalFilter(a)):h.__filter()}),h.plotData=function(){var a=h.chartBodyG().selectAll("path.symbol").data(h.data());a.enter().append("path").attr("class","symbol").attr("opacity",0).attr("fill",h.getColor).attr("transform",l),a.call(f,h.data()),a.each(function(a,b){v[b]=!h.filter()||h.filter().isFiltered([a.key[0],a.key[1]])}),c.transition(a,h.transitionDuration(),h.transitionDelay()).attr("opacity",function(a,b){return j(a)?v[b]?t:h.excludedOpacity():s}).attr("fill",function(a,b){return u&&!j(a)?u:h.excludedColor()&&!v[b]?h.excludedColor():h.getColor(a)}).attr("transform",l).attr("d",i),c.transition(a.exit(),h.transitionDuration(),h.transitionDelay()).attr("opacity",0).remove()},h.existenceAccessor=function(a){return arguments.length?(j=a,this):j},h.symbol=function(a){return arguments.length?(i.type(a),h):i.type()},h.customSymbol=function(a){return arguments.length?(i=a,i.size(e),h):i},h.symbolSize=function(a){return arguments.length?(n=a,h):n},h.highlightedSize=function(a){return arguments.length?(m=a,h):m},h.excludedSize=function(a){return arguments.length?(o=a,h):o},h.excludedColor=function(a){return arguments.length?(p=a,h):p},h.excludedOpacity=function(a){return arguments.length?(q=a,h):q},h.hiddenSize=h.emptySize=function(a){return arguments.length?(r=a,h):r},h.emptyColor=function(a){return arguments.length?(u=a,h):u},h.emptyOpacity=function(a){return arguments.length?(s=a,h):s},h.nonemptyOpacity=function(a){return arguments.length?(t=a,h):s},h.legendables=function(){return[{chart:h,name:h._groupName,color:h.getColor()}]},h.legendHighlight=function(b){g(function(a){return a.attr("fill")===b.color},m),h.chartBodyG().selectAll(".chart-body path.symbol").filter(function(){return a.select(this).attr("fill")!==b.color}).classed("fadeout",!0)},h.legendReset=function(b){g(function(a){return a.attr("fill")===b.color},n),h.chartBodyG().selectAll(".chart-body path.symbol").filter(function(){return a.select(this).attr("fill")!==b.color}).classed("fadeout",!1)},h.setHandlePaths=function(){},h.extendBrush=function(){var a=h.brush().extent();return h.round()&&(a[0]=a[0].map(h.round()),a[1]=a[1].map(h.round()),h.g().select(".brush").call(h.brush().extent(a))),a},h.brushIsEmpty=function(a){return h.brush().empty()||!a||a[0][0]>=a[1][0]||a[0][1]>=a[1][1]},h._brushing=function(){var a=h.extendBrush();if(h.redrawBrush(h.g()),h.brushIsEmpty(a))c.events.trigger(function(){h.filter(null),h.redrawGroup()});else{var b=c.filters.RangedTwoDimensionalFilter(a);c.events.trigger(function(){h.filter(null),h.filter(b),h.redrawGroup()},c.constants.EVENT_DELAY)}},h.setBrushY=function(a){a.call(h.brush().y(h.y()))},h.anchor(b,d)},c.numberDisplay=function(b,d){function e(a){if(!a.length)return null;var b=i._computeOrderedGroups(a);return b[b.length-1]}var f,g="number-display",h=a.format(".2s"),i=c.baseMixin({}),j={one:"",some:"",none:""};return i._mandatoryAttributes(["group"]),i.ordering(function(a){return a.value}),i.html=function(a){return arguments.length?(a.none?j.none=a.none:a.one?j.none=a.one:a.some&&(j.none=a.some),a.one?j.one=a.one:a.some&&(j.one=a.some),a.some?j.some=a.some:a.one&&(j.some=a.one),i):j},i.value=function(){return i.data()},i.data(function(a){var b=a.value?a.value():e(a.all());return i.valueAccessor()(b)}),i.transitionDuration(250),i.transitionDelay(0),i._doRender=function(){var b=i.value(),c=i.selectAll("."+g);c.empty()&&(c=c.data([0]).enter().append("span").attr("class",g)),c.transition().duration(i.transitionDuration()).delay(i.transitionDelay()).ease("quad-out-in").tween("text",function(){var c=isFinite(f)?f:0,d=a.interpolateNumber(c||0,b);return f=b,function(a){var c=null,e=i.formatNumber()(d(a));0===b&&""!==j.none?c=j.none:1===b&&""!==j.one?c=j.one:""!==j.some&&(c=j.some),this.innerHTML=c?c.replace("%number",e):e}})},i._doRedraw=function(){return i._doRender()},i.formatNumber=function(a){return arguments.length?(h=a,i):h},i.anchor(b,d)},c.heatMap=function(b,d){function e(a,b){var d=p.selectAll(".box-group").filter(function(c){return c.key[a]===b}),e=d.filter(function(a){return!p.hasFilter(a.key)});c.events.trigger(function(){var a=e.empty()?d:e,b=a.data().map(function(a){return c.filters.TwoDimensionalFilter(a.key)});p._filter([b]),p.redrawGroup()})}var f,g,h,i=6.75,j=a.ascending,k=a.ascending,l=a.scale.ordinal(),m=a.scale.ordinal(),n=i,o=i,p=c.colorMixin(c.marginMixin(c.baseMixin({})));p._mandatoryAttributes(["group"]),p.title(p.colorAccessor());var q=function(a){return a},r=function(a){return a};p.colsLabel=function(a){return arguments.length?(q=a,p):q},p.rowsLabel=function(a){return arguments.length?(r=a,p):r};var s=function(a){e(0,a)},t=function(a){e(1,a)},u=function(a){var b=a.key;c.events.trigger(function(){p.filter(b),p.redrawGroup()})};return c.override(p,"filter",function(a){return arguments.length?p._filter(c.filters.TwoDimensionalFilter(a)):p._filter()}),p.rows=function(a){return arguments.length?(h=a,p):h},p.rowOrdering=function(a){return arguments.length?(k=a,p):k},p.cols=function(a){return arguments.length?(g=a,p):g},p.colOrdering=function(a){return arguments.length?(j=a,p):j},p._doRender=function(){return p.resetSvg(),f=p.svg().append("g").attr("class","heatmap").attr("transform","translate("+p.margins().left+","+p.margins().top+")"),p._doRedraw()},p._doRedraw=function(){var a=p.data(),b=p.rows()||a.map(p.valueAccessor()),d=p.cols()||a.map(p.keyAccessor());k&&(b=b.sort(k)),j&&(d=d.sort(j)),b=m.domain(b),d=l.domain(d);var e=b.domain().length,g=d.domain().length,h=Math.floor(p.effectiveWidth()/g),i=Math.floor(p.effectiveHeight()/e);d.rangeRoundBands([0,p.effectiveWidth()]),b.rangeRoundBands([p.effectiveHeight(),0]);var q=f.selectAll("g.box-group").data(p.data(),function(a,b){return p.keyAccessor()(a,b)+"\0"+p.valueAccessor()(a,b)}),r=q.enter().append("g").attr("class","box-group");r.append("rect").attr("class","heat-box").attr("fill","white").on("click",p.boxOnClick()),p.renderTitle()&&(r.append("title"),q.select("title").text(p.title())),c.transition(q.select("rect"),p.transitionDuration(),p.transitionDelay()).attr("x",function(a,b){return d(p.keyAccessor()(a,b))}).attr("y",function(a,c){return b(p.valueAccessor()(a,c))}).attr("rx",n).attr("ry",o).attr("fill",p.getColor).attr("width",h).attr("height",i),q.exit().remove();var s=f.select("g.cols");s.empty()&&(s=f.append("g").attr("class","cols axis"));var t=s.selectAll("text").data(d.domain());t.enter().append("text").attr("x",function(a){return d(a)+h/2}).style("text-anchor","middle").attr("y",p.effectiveHeight()).attr("dy",12).on("click",p.xAxisOnClick()).text(p.colsLabel()),c.transition(t,p.transitionDuration(),p.transitionDelay()).text(p.colsLabel()).attr("x",function(a){return d(a)+h/2}).attr("y",p.effectiveHeight()),t.exit().remove();var u=f.select("g.rows");u.empty()&&(u=f.append("g").attr("class","rows axis"));var v=u.selectAll("text").data(b.domain());return v.enter().append("text").attr("dy",6).style("text-anchor","end").attr("x",0).attr("dx",-2).on("click",p.yAxisOnClick()).text(p.rowsLabel()),c.transition(v,p.transitionDuration(),p.transitionDelay()).text(p.rowsLabel()).attr("y",function(a){return b(a)+i/2}),v.exit().remove(),p.hasFilter()?p.selectAll("g.box-group").each(function(a){p.isSelectedNode(a)?p.highlightSelected(this):p.fadeDeselected(this)}):p.selectAll("g.box-group").each(function(){p.resetHighlight(this)}),p},p.boxOnClick=function(a){return arguments.length?(u=a,p):u},p.xAxisOnClick=function(a){return arguments.length?(s=a,p):s},p.yAxisOnClick=function(a){return arguments.length?(t=a,p):t},p.xBorderRadius=function(a){return arguments.length?(n=a,p):n},p.yBorderRadius=function(a){return arguments.length?(o=a,p):o},p.isSelectedNode=function(a){return p.hasFilter(a.key)},p.anchor(b,d)},function(){function b(a){return[0,a.length-1]}function c(b){return[a.quantile(b,.25),a.quantile(b,.5),a.quantile(b,.75)]}a.box=function(){function d(b){b.each(function(b,c){b=b.map(j).sort(a.ascending);var d=a.select(this),n=b.length,o=b[0],p=b[n-1],q=b.quartiles=l(b),r=k&&k.call(this,b,c),s=r&&r.map(function(a){return b[a]}),t=r?a.range(0,r[0]).concat(a.range(r[1]+1,n)):a.range(n),u=a.scale.linear().domain(i&&i.call(this,b,c)||[o,p]).range([f,0]),v=this.__chart__||a.scale.linear().domain([0,1/0]).range(u.range());this.__chart__=u;var w=d.selectAll("line.center").data(s?[s]:[]);w.enter().insert("line","rect").attr("class","center").attr("x1",e/2).attr("y1",function(a){return v(a[0])}).attr("x2",e/2).attr("y2",function(a){return v(a[1])}).style("opacity",1e-6).transition().duration(g).delay(h).style("opacity",1).attr("y1",function(a){return u(a[0])}).attr("y2",function(a){return u(a[1])}),w.transition().duration(g).delay(h).style("opacity",1).attr("x1",e/2).attr("x2",e/2).attr("y1",function(a){return u(a[0])}).attr("y2",function(a){return u(a[1])}),w.exit().transition().duration(g).delay(h).style("opacity",1e-6).attr("y1",function(a){return u(a[0])}).attr("y2",function(a){return u(a[1])}).remove();var x=d.selectAll("rect.box").data([q]);x.enter().append("rect").attr("class","box").attr("x",0).attr("y",function(a){return v(a[2])}).attr("width",e).attr("height",function(a){return v(a[0])-v(a[2])}).transition().duration(g).delay(h).attr("y",function(a){return u(a[2])}).attr("height",function(a){return u(a[0])-u(a[2])}),x.transition().duration(g).delay(h).attr("width",e).attr("y",function(a){return u(a[2])}).attr("height",function(a){return u(a[0])-u(a[2])});var y=d.selectAll("line.median").data([q[1]]);y.enter().append("line").attr("class","median").attr("x1",0).attr("y1",v).attr("x2",e).attr("y2",v).transition().duration(g).delay(h).attr("y1",u).attr("y2",u),y.transition().duration(g).delay(h).attr("x1",0).attr("x2",e).attr("y1",u).attr("y2",u);var z=d.selectAll("line.whisker").data(s||[]);z.enter().insert("line","circle, text").attr("class","whisker").attr("x1",0).attr("y1",v).attr("x2",e).attr("y2",v).style("opacity",1e-6).transition().duration(g).delay(h).attr("y1",u).attr("y2",u).style("opacity",1),z.transition().duration(g).delay(h).attr("x1",0).attr("x2",e).attr("y1",u).attr("y2",u).style("opacity",1),z.exit().transition().duration(g).delay(h).attr("y1",u).attr("y2",u).style("opacity",1e-6).remove();var A=d.selectAll("circle.outlier").data(t,Number);A.enter().insert("circle","text").attr("class","outlier").attr("r",5).attr("cx",e/2).attr("cy",function(a){return v(b[a])}).style("opacity",1e-6).transition().duration(g).delay(h).attr("cy",function(a){return u(b[a])}).style("opacity",1),A.transition().duration(g).delay(h).attr("cx",e/2).attr("cy",function(a){return u(b[a])}).style("opacity",1),A.exit().transition().duration(g).delay(h).attr("cy",function(a){return u(b[a])}).style("opacity",1e-6).remove();var B=m||u.tickFormat(8),C=d.selectAll("text.box").data(q);C.enter().append("text").attr("class","box").attr("dy",".3em").attr("dx",function(a,b){return 1&b?6:-6}).attr("x",function(a,b){return 1&b?e:0}).attr("y",v).attr("text-anchor",function(a,b){return 1&b?"start":"end"}).text(B).transition().duration(g).delay(h).attr("y",u),C.transition().duration(g).delay(h).text(B).attr("x",function(a,b){return 1&b?e:0}).attr("y",u);var D=d.selectAll("text.whisker").data(s||[]);D.enter().append("text").attr("class","whisker").attr("dy",".3em").attr("dx",6).attr("x",e).attr("y",v).text(B).style("opacity",1e-6).transition().duration(g).delay(h).attr("y",u).style("opacity",1),D.transition().duration(g).delay(h).text(B).attr("x",e).attr("y",u).style("opacity",1),D.exit().transition().duration(g).delay(h).attr("y",u).style("opacity",1e-6).remove()}),a.timer.flush()}var e=1,f=1,g=0,h=0,i=null,j=Number,k=b,l=c,m=null;return d.width=function(a){return arguments.length?(e=a,d):e},d.height=function(a){return arguments.length?(f=a,d):f},d.tickFormat=function(a){return arguments.length?(m=a,d):m},d.duration=function(a){return arguments.length?(g=a,d):g},d.domain=function(b){return arguments.length?(i=null===b?b:a.functor(b),d):i},d.value=function(a){return arguments.length?(j=a,d):j},d.whiskers=function(a){return arguments.length?(k=a,d):k},d.quartiles=function(a){return arguments.length?(l=a,d):l},d}}(),c.boxPlot=function(b,d){function e(a){return function(b){var c=b.quartiles[0],d=b.quartiles[2],e=(d-c)*a,f=-1,g=b.length;do++f;while(b[f]<c-e);do--g;while(b[g]>d+e);return[f,g]}}function f(a){var b=a.enter().append("g");b.attr("class","box").attr("transform",p).call(m).on("click",function(a){i.filter(i.keyAccessor()(a)),i.redrawGroup()})}function g(b){c.transition(b,i.transitionDuration(),i.transitionDelay()).attr("transform",p).call(m).each(function(){a.select(this).select("rect.box").attr("fill",i.getColor)})}function h(a){a.exit().remove().call(m)}var i=c.coordinateGridMixin({}),j=1.5,k=e,l=k(j),m=a.box(),n=null,o=function(a,b){return i.isOrdinal()?i.x().rangeBand():a/(1+i.boxPadding())/b};i.yAxisPadding(12),i.x(a.scale.ordinal()),i.xUnits(c.units.ordinal),i.data(function(a){return a.all().map(function(a){return a.map=function(b){return b.call(a,a)},a}).filter(function(a){var b=i.valueAccessor()(a);return 0!==b.length})}),i.boxPadding=i._rangeBandPadding,i.boxPadding(.8),i.outerPadding=i._outerRangeBandPadding,i.outerPadding(.5),i.boxWidth=function(b){return arguments.length?(o=a.functor(b),i):o};var p=function(a,b){var c=i.x()(i.keyAccessor()(a,b));return"translate("+c+", 0)"};return i._preprocessData=function(){i.elasticX()&&i.x().domain([])},i.plotData=function(){var a=o(i.effectiveWidth(),i.xUnitCount());m.whiskers(l).width(a).height(i.effectiveHeight()).value(i.valueAccessor()).domain(i.y().domain()).duration(i.transitionDuration()).tickFormat(n);var b=i.chartBodyG().selectAll("g.box").data(i.data(),i.keyAccessor());f(b),g(b),h(b),i.fadeDeselectedArea()},i.fadeDeselectedArea=function(){if(i.hasFilter())if(i.isOrdinal())i.g().selectAll("g.box").each(function(a){i.isSelectedNode(a)?i.highlightSelected(this):i.fadeDeselected(this)});else{var a=i.brush().extent(),b=a[0],c=a[1],d=i.keyAccessor();i.g().selectAll("g.box").each(function(a){var e=d(a);e<b||e>=c?i.fadeDeselected(this):i.highlightSelected(this)})}else i.g().selectAll("g.box").each(function(){i.resetHighlight(this)})},i.isSelectedNode=function(a){return i.hasFilter(i.keyAccessor()(a))},i.yAxisMin=function(){var b=a.min(i.data(),function(b){return a.min(i.valueAccessor()(b))});return c.utils.subtract(b,i.yAxisPadding())},i.yAxisMax=function(){var b=a.max(i.data(),function(b){return a.max(i.valueAccessor()(b))});return c.utils.add(b,i.yAxisPadding())},i.tickFormat=function(a){return arguments.length?(n=a,i):n},i.anchor(b,d)},c.selectMenu=function(b,d){function e(){var a=h.selectAll("option."+j).data(k.data(),function(a){return k.keyAccessor()(a)});return a.enter().append("option").classed(j,!0).attr("value",function(a){return k.keyAccessor()(a)}),a.text(k.title()),a.exit().remove(),h.selectAll("option."+j).sort(p),h.on("change",f),a}function f(b,c){var d,e=a.event.target;if(e.selectedOptions){var f=Array.prototype.slice.call(e.selectedOptions);d=f.map(function(a){return a.value})}else{var g=[].slice.call(a.event.target.options);d=g.filter(function(a){return a.selected}).map(function(a){return a.value})}1===d.length&&""===d[0]?d=n||null:m||1!==d.length||(d=d[0]),k.onChange(d)}function g(){m?h.attr("multiple",!0):h.attr("multiple",null),null!==o?h.attr("size",o):h.attr("size",null)}var h,i="dc-select-menu",j="dc-select-option",k=c.baseMixin({}),l="Select all",m=!1,n=null,o=null,p=function(a,b){return k.keyAccessor()(a)>k.keyAccessor()(b)?1:k.keyAccessor()(b)>k.keyAccessor()(a)?-1:0},q=function(a){return k.valueAccessor()(a)>0};k.data(function(a){return a.all().filter(q)}),k._doRender=function(){return k.select("select").remove(),h=k.root().append("select").classed(i,!0),h.append("option").text(l).attr("value",""),k._doRedraw(),k};var r=window.navigator.userAgent;return r.indexOf("Trident/")>0&&r.indexOf("MSIE")===-1&&(k.redraw=k.render),k._doRedraw=function(){return g(),e(),k.hasFilter()&&m?h.selectAll("option").property("selected",function(a){return"undefined"!=typeof a&&k.filters().indexOf(String(k.keyAccessor()(a)))>=0}):k.hasFilter()?h.property("value",k.filter()):h.property("value",""),k},k.onChange=function(a){a&&m?k.replaceFilter([a]):a?k.replaceFilter(a):k.filterAll(),c.events.trigger(function(){k.redrawGroup()})},k.order=function(a){return arguments.length?(p=a,k):p},k.promptText=function(a){return arguments.length?(l=a,k):l},k.filterDisplayed=function(a){return arguments.length?(q=a,k):q},k.multiple=function(a){return arguments.length?(m=a,k):m},k.promptValue=function(a){return arguments.length?(n=a,k):n},k.numberVisible=function(a){return arguments.length?(o=a,k):o},k.size=c.logger.deprecate(k.numberVisible,"selectMenu.size is ambiguous - use numberVisible instead"),k.anchor(b,d)},c.barChartOrdinal=function(b,d){function e(a){var b=m.height()-m.margins().top-m.margins().bottom;g.selectAll("rect").transition().duration(m.transitionDuration()).attr("y",function(a){return i(a.x0+Math.abs(a.x))}).attr("height",function(a){return i(a.x0)-i(a.x0+Math.abs(a.x))}),g.selectAll(".x.axis text").attr("dy",b-i(0))}function f(){var b=m.data(),c=m.margins(),d=m.height(),f=m.width(),n=l,o=m.width()-m.margins().left-m.margins().right,p=m.height()-m.margins().top-m.margins().bottom;m.title(function(a){return a.z});var q=g.attr("width",f).attr("height",d).append("g").attr("transform","translate("+c.left+","+c.top+")"),r=a.min(b,function(b){return a.min(b,function(a){return a.x0})}),s=a.max(b,function(b){return a.max(b,function(a){return a.x+a.x0})}),t=b[0].map(function(a){return a.y});i=a.scale.linear().domain([s,r]).range([0,d-c.top-c.bottom]),h=a.scale.ordinal().domain(t).rangeRoundBands([0,f-c.left-c.right],.1);var u=a.svg.axis().scale(h).orient("bottom"),v=a.svg.axis().scale(i).orient("left"),w=q.selectAll(".chartGroup").data(b).enter().append("g");w.selectAll("rect").data(function(a){return a}).enter().append("rect").style("fill",function(a){return n(a.z)}).attr("y",function(a){return i(0)}).attr("x",function(a,b){return h(a.y)}).attr("width",function(a){return h.rangeBand()}).attr("height",function(a){return 0}).append("svg:title").text(function(a){return a.z+": "+a.x}),q.append("g").attr("class","x-axis-label x-label").append("text").attr("x",-m.margins().right+o/2).attr("y",p+m.margins().bottom-10).text(j),q.append("g").attr("class","y-axis-label y-label").append("text").attr("x",-(p/2)).attr("y",-m.margins().left+15).attr("transform","rotate(-90)").text(k),q.append("g").attr("class","x axis").attr("transform","translate(0,"+i(0)+")").call(u),q.append("g").attr("class","y axis").call(v).selectAll("text").attr("dy","0.1em").style("text-anchor","end"),e(b)}var g,h,i,j,k,l,m=c.marginMixin(c.baseMixin({}));m.margins().top=20,m.margins().right=20,m.margins().bottom=40,m.margins().left=40;var n=function(){var a={};return function(b,c,d){var e=a[b.x];e||(e=[0,0]),d>=0?(b.y0=e[0],b.y=d,e[0]+=d):(b.y0=e[1]+d,b.y=d,e[1]+=d),a[b.x]=e}};return m.colors=function(a){return l=a,m},m.data(function(b){var c=b.map(function(a){return a.key[1].map(function(b,c){return{x:b.title,y:b.value,z:a.key[0]}})}),d=a.layout.stack().out(n());return d(c),c=c.map(function(a){return a.map(function(a){return{x:a.y,y:a.x,x0:a.y0,z:a.z}})})}),m.label(function(a){return c.utils.printSingleValue(a.x0+a.x)},!1),m._doRender=function(){return m.resetSvg(),g=m.svg(),f(),m},m._doRedraw=function(){var a=m.data();return e(a),m},m.xAxisLabel=function(a){return j=a,m},m.yAxisLabel=function(a){return k=a,m},m.anchor(b,d)},c.groupedBarChart=function(b,d){function e(){s=n.data(),s.length>0&&(t=s[0].groupData.map(function(a){return a.name}))}function f(){y=y||0,q=q||0;var b=a.min(s,function(b){return a.min(b.groupData,function(a){return a.value})}),c=a.max(s,function(b){return a.max(b.groupData,function(a){return a.value})});return b>y&&(b=y),c<q&&(c=q),{min:b,max:c}}function g(){var a=r.selectAll(".chartGroup").data(s),b=f();a.selectAll("text").data(function(a){return a.groupData}).text(function(a){return+a.value>0?w(+a.value):""}).transition().duration(n.transitionDuration()).attr("y",function(a){return u(Math.max(0,a.value))}).style("fill","#000000"),a.selectAll("rect").data(function(a){return a.groupData}).transition().duration(n.transitionDuration()).attr("y",function(a){return u(Math.max(0,a.value))}).attr("height",function(a){return Math.abs(u(a.value-Math.max(0,b.min))-u(0))}),b.min<0&&r.selectAll(".x.axis text").attr("dy",u(0))}function h(){l=n.width()-n.margins().left-n.margins().right,m=n.height()-n.margins().top-n.margins().bottom,e();var b=f();if(0!==s.length){var c=a.scale.ordinal().rangeRoundBands([0,l],.15),d=a.scale.ordinal();u=a.scale.linear().range([m,0]),n.y=function(){return function(a){return u(a)}};var h=v,j=a.svg.axis().scale(c).orient("bottom"),k=a.svg.axis().scale(u).orient("left").tickFormat(x);r=i.attr("width",n.width()).attr("height",n.height()).append("g").attr("class","chart-body").attr("transform","translate("+n.margins().left+","+n.margins().top+")"),c.domain(s.map(function(a){return a.key})),d.domain(t).rangeRoundBands([0,c.rangeBand()]),u.domain([b.min,b.max]),r.append("g").attr("class","x-axis-label x-label").append("text").attr("x",-n.margins().right+l/2).attr("y",m+n.margins().bottom-10).text(o),r.append("g").attr("class","y-axis-label y-label").append("text").attr("x",-(m/2)).attr("y",-n.margins().left+15).attr("transform","rotate(-90)").text(p),r.append("g").attr("class","x axis").attr("transform","translate(0,"+u(Math.max(0,b.min))+")").call(j),r.append("g").attr("class","y axis").call(k).append("text");var q=r.selectAll(".chartGroup").data(s).enter().append("g").attr("class","chartGroup").attr("transform",function(a){return"translate("+c(a.key)+",0)"});q.selectAll("rect").data(function(a){for(var b=0;b<a.groupData.length;b++)a.groupData[b].key=a.key;return a.groupData}).enter().append("rect").style("fill",function(a){return z.indexOf(a.key)!==-1?A:h(a.name)}).attr("width",d.rangeBand()).attr("x",function(a){return d(a.name)}).append("title").text(function(a){return a.name+": "+a.value}),g()}}var i,j=100,k=100,l=j,m=k,n=c.marginMixin(c.baseMixin({}));n.margins().top=20,n.margins().right=20,n.margins().bottom=40,n.margins().left=40;var o,p,q,r,s,t,u,v,w=a.format(",.0f"),x=a.format(",.0f"),y=0,z=[],A="#ff0000";n.highlightColor=function(a){return A=a,n},n.highlightVariables=function(a){return z=a,n};var B=function(a){return a};n.colors=function(a){return $.isFunction(a)&&(v=a),n},n.yAxisLabelFormat=function(a){return void 0===a?x:(x=a,n)},n.yAxisMinValue=function(a){return a&&(y=a),n},n.yAxisMaxValue=function(a){return a&&(q=a),n};var C=function(a){return a.value};return n.valueAccessor=function(a){return void 0===a?C:(C=a,n)},n.width=function(a){return void 0===a?j:(j=a,n)},n.height=function(a){return void 0===a?k:(k=a,n)},n.xAxisLabel=function(a){return o=a,n},n.yAxisLabel=function(a){return p=a,n},n.seriesSort=function(a){return $.isFunction(a)?void(B=a):B},n.parseGroup=function(a){var b={},c=[],d=[],e=[];if(a.all().map(function(a){c.indexOf(a.key[0])===-1&&c.push(a.key[0]),d.indexOf(a.key[1])===-1&&d.push(a.key[1]),b[a.key[0]]=b[a.key[0]]||{},b[a.key[0]][a.key[1]]={value:n.valueAccessor()(a),order:a.key[3]}}),c.map(function(a){var c={key:a,groupData:[]};d.map(function(d){var e=b[a][d];c.groupData.push({name:d,value:e.value,order:e.order})}),c.groupData.sort(function(a,b){return a.order>b.order?1:a.order<b.order?-1:0}),e.push(c)}),n.sortArray){var f=[];n.sortArray.forEach(function(a){var b=!1;e=e.filter(function(c){return!(!b&&c.key===a)||(f.push(c),b=!0,!1)})}),e=f}return e},n.data(function(a){return n.parseGroup(a)}),n._doRender=function(){return n.resetSvg(),i=n.svg(),h(),n},n._doRedraw=function(){return e(),g(),n},n.anchor(b,d)},c.groupedRowChart=function(b,d){function e(){C=C||0,q=q||0;var b=a.min(w,function(b){return a.min(b.groupData,function(a){return a.value})}),c=a.max(w,function(b){return a.max(b.groupData,function(a){return a.value})});return b>C&&(b=C),c<q&&(c=q),{min:b,max:c}}function f(){var a=v.selectAll(".chartGroup").data(w),b=e();a.selectAll("text").data(function(a){return a.groupData}).text(function(a){return+a.value>0?A(+a.value):""}).transition().duration(n.transitionDuration()).attr("x",function(a){return z(Math.min(0,a.value))}).style("fill","#000000"),a.selectAll("rect").data(function(a){return a.groupData}).attr("width",function(a){return Math.abs(z(a.value)-z(Math.max(0,b.min)))}),b.min<0&&v.selectAll(".y.axis text").attr("dx",-z(0))}function g(){w=n.data(),w.length>0&&(y=w[0].groupData.map(function(a){return a.name}))}function h(){l=n.width()-n.margins().left-n.margins().right,m=n.height()-n.margins().top-n.margins().bottom,s=a.scale.ordinal().rangeRoundBands([0,m],.15),r=a.scale.ordinal(),z=a.scale.linear().range([0,l]),t=a.svg.axis().scale(z).orient("bottom").tickFormat(B),u=a.svg.axis().scale(s).orient("left"),v=i.attr("width",n.width()).attr("height",n.height()).append("g").attr("transform","translate("+n.margins().left+","+n.margins().top+")"),g();var b=e();if(0!==w.length){s.domain(w.map(function(a){return a.key})),r.domain(y).rangeRoundBands([0,s.rangeBand()]),z.domain([b.min,b.max]),v.append("g").attr("class","x-axis-label x-label").append("text").attr("x",-n.margins().right+l/2).attr("y",m+n.margins().bottom-10).text(o),
v.append("g").attr("class","y-axis-label y-label").append("text").attr("x",-(m/2)).attr("y",-n.margins().left+15).attr("transform","rotate(-90)").text(p),v.append("g").attr("class","x axis").attr("transform","translate(0,"+m+")").call(t),v.append("g").attr("class","y axis").attr("transform","translate("+z(Math.max(0,b.min))+",0)").call(u).selectAll("text").attr("dy","0em").attr("transform","rotate(-90)").style("text-anchor","end");var c=v.selectAll(".chartGroup").data(w).enter().append("g").attr("class","chartGroup").attr("transform",function(a){return"translate(0, "+s(a.key)+")"});c.selectAll("rect").data(function(a){for(var b=0;b<a.groupData.length;b++)a.groupData[b].key=a.key;return a.groupData}).enter().append("rect").style("fill",function(a){return D.indexOf(a.key)!==-1?E:x(a.name)}).attr("height",r.rangeBand()).attr("y",function(a){return r(a.name)}).attr("width",function(a){return 0}).attr("x",function(a){return z(Math.min(0,a.value)+Math.max(0,b.min))}).append("title").text(function(a){return a.name+": "+a.value}),f()}}var i,j=100,k=100,l=j,m=k,n=c.marginMixin(c.baseMixin({}));n.margins().top=20,n.margins().right=20,n.margins().bottom=40,n.margins().left=40;var o,p,q,r,s,t,u,v,w,x,y,z,A=a.format(",.0f"),B=a.format(",.0f"),C=0,D=[],E="#ff0000",F=function(a){return a.name},G=function(a){return a.value};return n.highlightVariables=function(a){return D=a,n},n.highlightColor=function(a){return E=a,n},n.colors=function(a){return $.isFunction(a)&&(x=a),n},n.seriesSort=function(a){return $.isFunction(a)?void(F=a):F},n.xAxisLabelFormat=function(b){return void 0===b?B:(B=a.format(b),n)},n.valueLabelFormat=function(b){return void 0===b?A:(A=a.format(b),n)},n.valueAccessor=function(a){return void 0===a?G:(G=a,n)},n.width=function(a){return void 0===a?j:(j=a,n)},n.height=function(a){return void 0===a?k:(k=a,n)},n.xAxisLabel=function(a){return o=a,n},n.yAxisLabel=function(a){return p=a,n},n.yAxisMinValue=function(a){return a&&(C=a),n},n.yAxisMaxValue=function(a){return a&&(q=a),n},n.parseGroup=function(a){var b={},c=[],d=[],e=[];if(a.all().map(function(a){c.indexOf(a.key[0])===-1&&c.push(a.key[0]),d.indexOf(a.key[1])===-1&&d.push(a.key[1]),b[a.key[0]]=b[a.key[0]]||{},b[a.key[0]][a.key[1]]={value:n.valueAccessor()(a),order:a.key[3]}}),c.map(function(a){var c={key:a,groupData:[]};d.map(function(d){var e=b[a][d];c.groupData.push({name:d,value:e.value,order:e.order})}),c.groupData.sort(function(a,b){return a.order>b.order?1:a.order<b.order?-1:0}),e.push(c)}),n.sortArray){var f=[];n.sortArray.forEach(function(a){var b=!1;e=e.filter(function(c){return!(!b&&c.key===a)||(f.push(c),b=!0,!1)})}),e=f}return e},n.data(function(a){return n.parseGroup(a)}),n._doRender=function(){return n.resetSvg(),i=n.svg(),h(),n},n._doRedraw=function(){return g(),f(),n},n.anchor(b,d)},c.groupedStackedRowChart=function(b,d){function e(a){g.selectAll("rect").transition().duration(m.transitionDuration()).attr("x",function(a){return h(a.x0)}).attr("width",function(a){return Math.abs(h(a.x)-h(0))}),g.selectAll(".y.axis text").attr("dx",-h(0))}function f(){var b=m.data(),c=m.margins(),d=m.height(),f=m.width(),n=l,o=m.width()-m.margins().left-m.margins().right,p=m.height()-m.margins().top-m.margins().bottom;m.title(function(a){return a.z});var q=g.attr("width",f).attr("height",d).append("g").attr("transform","translate("+c.left+","+c.top+")"),r=a.min(b,function(b){return a.min(b,function(a){return a.x0})}),s=a.max(b,function(b){return a.max(b,function(a){return a.x+a.x0})}),t=b[0].map(function(a){return a.y});h=a.scale.linear().domain([r,s]).range([0,f-c.left-c.right]),i=a.scale.ordinal().domain(t).rangeRoundBands([0,d-c.top-c.bottom],.1);var u=a.svg.axis().scale(h).orient("bottom"),v=a.svg.axis().scale(i).orient("left"),w=q.selectAll(".chartGroup").data(b).enter().append("g");w.selectAll("rect").data(function(a){return a}).enter().append("rect").style("fill",function(a){return n(a.z)}).attr("x",function(a){return 0}).attr("y",function(a,b){return i(a.y)}).attr("height",function(a){return i.rangeBand()}).attr("width",function(a){return 0}).append("svg:title").text(function(a){return a.z+": "+a.x}),q.append("g").attr("class","x-axis-label x-label").append("text").attr("x",-m.margins().right+o/2).attr("y",p+m.margins().bottom-10).text(j),q.append("g").attr("class","y-axis-label y-label").append("text").attr("x",-(p/2)).attr("y",-m.margins().left+15).attr("transform","rotate(-90)").text(k),q.append("g").attr("class","x axis").attr("transform","translate(0,"+(d-c.top-c.bottom)+")").call(u),q.append("g").attr("class","y axis").attr("transform","translate("+h(0)+",0)").call(v).selectAll("text").attr("dy","0em").style("text-anchor","end"),e(b)}var g,h,i,j,k,l,m=c.marginMixin(c.baseMixin({animation:!1}));m.margins().top=20,m.margins().right=20,m.margins().bottom=40,m.margins().left=40;var n=function(){var a={};return function(b,c,d){var e=a[b.x];e||(e=[0,0]),d>=0?(b.y0=e[0],b.y=d,e[0]+=d):(b.y0=e[1]+d,b.y=d,e[1]+=d),a[b.x]=e}};return m.colors=function(a){return l=a,m},m.xAxisLabel=function(a){return j=a,m},m.yAxisLabel=function(a){return k=a,m},m.data(function(b){var c=b.map(function(a){return a.key[1].map(function(b,c){return{x:b.title,y:b.value,z:a.key[0]}})}),d=a.layout.stack().out(n());return d(c),c=c.map(function(a){return a.map(function(a){return{x:a.y,y:a.x,x0:a.y0,z:a.z}})})}),m.label(function(a){return c.utils.printSingleValue(a.x0+a.x)},!1),m._doRender=function(){return m.resetSvg(),g=m.svg(),f(),m},m._doRedraw=function(){var a=m.data();return e(a),m},m.anchor(b,d)},c.stackedRowChart=function(b,d){function e(){var b=g.data(),c=g.height(),d=g.width(),e=f.attr("width",g.width()).attr("height",g.height()).append("g").attr("transform","translate("+g.margins().left+","+g.margins().top+")"),h=a.max(b,function(b){return a.max(b,function(a){return a.x+a.x0})}),i=a.scale.linear().domain([0,h]).range([0,d]),j=b[0].map(function(a){return a.y}),k=a.scale.ordinal().domain(j).rangeRoundBands([0,c],.1),l=a.svg.axis().scale(i).orient("bottom"),m=a.svg.axis().scale(k).orient("left"),n=a.scale.category10(),o=e.selectAll("g").data(b).enter().append("g").style("fill",function(a,b){return n(b)});o.selectAll("rect").data(function(a){return a}).enter().append("rect").attr("x",function(a){return i(a.x0)}).attr("y",function(a,b){return k(a.y)}).attr("height",function(a){return k.rangeBand()}).attr("width",function(a){return i(a.x)}).on("mouseover",function(b){var c=parseFloat(a.select(this).attr("x"))/2+d/2,e=parseFloat(a.select(this).attr("y"))+k.rangeBand()/2;a.select("#tooltip").style("left",c+"px").style("top",e+"px").select("#value").text(b.x),a.select("#tooltip").classed("hidden",!1)}).on("mouseout",function(){a.select("#tooltip").classed("hidden",!0)}),e.append("g").attr("class","axis").attr("transform","translate(0,"+c+")").call(l),e.append("g").attr("class","axis").call(m)}var f,g=c.marginMixin(c.baseMixin({}));g.margins().top=20,g.margins().right=20,g.margins().bottom=40,g.margins().left=40;var h=function(){var a={};return function(b,c,d){var e=a[b.x];e||(e=[0,0]),d>=0?(b.y0=e[0],b.y=d,e[0]+=d):(b.y0=e[1]+d,b.y=d,e[1]+=d),a[b.x]=e}};return g.data(function(b){var c=b.all().slice(),d=c.map(function(a){return a.key[1].map(function(b,c){return{x:b.title,y:b.value,z:a.key[0]}})}),e=a.layout.stack().out(h());return e(d),d=d.map(function(a){return a.map(function(a){return{x:a.y,y:a.x,x0:a.y0,z:a.z}})})}),g._doRender=function(){return g.resetSvg(),f=g.svg(),e(),g},g._doRedraw=function(){return g},g.anchor(b,d)},c.statColorScales={admOrdinal:function(){return a.scale.ordinal().range(["#FF0200","#D9007B","#FF6700","#FEFF00","#00CC05","#0053CC","#8B00CC","#FF0200","#FFCD00","#A8E500","#0098CC"])},iPodNano:function(){return a.scale.ordinal().range(["#8569CF","#0D9FD8","#8AD749","#EECE00","#F8981F","#F80E27","#F640AE","#E2E2E2","#787679"])},google:function(b,c){var d=a.scale.ordinal().range(["#3366cc","#dc3912","#ff9900","#109618","#990099","#0099c6","#dd4477","#66aa00","#b82e2e","#316395","#994499","#22aa99","#aaaa11","#6633cc","#e67300","#8b0707","#651067","#329262","#5574a6","#3b3eac"]);return void 0!==b&&b.constructor===Array&&b.length>0&&void 0!==c?function(a){return b.indexOf(a)!==-1?c:d(a)}:function(a){return d(a)}},plannedActual:function(){return a.scale.ordinal().domain(["Black","Planned","Actual"]).range(["#000000","#3366cc","#dc3912"])}},c.statLegend={pieLegend:function(a,b){var d=this.calcLegendHeight(a,b),e=d+a.radius(),f=this.calcLegendWidth(b),g=this.calcLegendItemWidth(b);a.cy(e).legend(c.legend().y(b.margins.top).x(b.margins.left).itemHeight(b.legendItemHeight).gap(b.legendGap).autoItemWidth(b.autoItemWidth).legendWidth(f).itemWidth(g).horizontal(b.horizontalLegend))},legend:function(a,b,d){d&&this.overrideLegendables(a,b);var e=this.calcLegendHeight(a,b),f=this.calcLegendWidth(b),g=this.calcLegendItemWidth(b);a.legend(c.legend().y(b.margins.top).x(b.margins.left-b.chartConfig.yAxisLabelPadding).itemHeight(b.legendItemHeight).gap(b.legendGap).autoItemWidth(b.autoItemWidth).legendWidth(f).itemWidth(g).horizontal(b.horizontalLegend)),a.margins().top=e+2*a.margins().top},overrideLegendables:function(a,b){a.legendables=function(){var c=a.data();return c.length>0?c[0].groupData.map(function(c){return c.chart=a,c.color=b.colors(c.name),c}):[]},a.isLegendableHidden=function(){return!1}},calcLegendHeight:function(a,b){var c=a.legendables(),d=c?c.length:0;return b.horizontalLegend&&(d=Math.ceil(d/2)),(b.legendItemHeight+b.legendGap)*d},calcLegendWidth:function(a){return a.horizontalLegend?a.legendWidth/2:a.legendWidth},calcLegendItemWidth:function(a){return a.horizontalLegend?a.legendItemWidth/2*.9:a.legendItemWidth}},c.statDiagrams={monthMap:{1:"J",2:"F",3:"M",4:"A",5:"M",6:"J",7:"J",8:"A",9:"S",10:"O",11:"N",12:"D"},scaleWidth:function(a,b){return b*a/100},scaleHeight:function(a,b){return b*a/100},objectId:0,options:{minHeight:300,xAxisTitle:"",yAxisTitle:"",margins:{top:60,right:20,bottom:40,left:40},legend:!0,autoItemWidth:!1,legendItemHeight:15,legendGap:5,colors:c.statColorScales.google(),horizontalLegend:!0,xAxisLabelRotate:!1,xAxisLabelOffsetX:0,xAxisLabelOffsetY:0,valueAccessor:function(a){return a.value},keyAccessor:function(a){return a.key},seriesAccessor:function(a){return a.value}},compare2DKey:function(a,b){var c=a.key.split("|"),d=b.key.split("|");if(c.length<2||d.length<2)return 0;var e=c[0],f=d[0],g=c[1],h=d[1];return e<f?-1:e>f?1:+g<+h?-1:+g>+h?1:0},groupStripKey:function(a,b){return{all:function(){for(var c=a.all(),d=0;d<c.length;d++)if(c[d].key===b){c.splice(d,1);break}return c}}},getRunningSumFor2DKeyGroup:function(a,b,c){return void 0===b&&(b="runningSum"),void 0===c&&(c=function(a){return a.value}),{all:function(){for(var d=0,e="",f=a.all(),g=0;g<f.length;g++){var h=f[g].key.split("|")[0];h!==e&&(d=0);var i=c(f[g]);d+=isNaN(i)?0:i,f[g][b]=d,e=h}return f}}},dropDownFilterProjStatus:function(a,b,c,d){for(var e=["Execution","Liability","Completed","Closed"],f="ddf"+this.objectId++,g=$("<select/>").attr("id",f).addClass("form-control"),h=$("<label/>").attr("for",f).text(a),i=0;i<e.length;i++){var j=$("<option/>").attr("value",e[i]).text(e[i]);g.append(j)}g.val(c),g.on("change",function(){d($(this).val())}),$(b).empty().append(h).append(g).addClass("form-group")},dropDownFilterYear:function(a,b,c,d,e){for(var f="ddf"+this.objectId++,g=$("<select/>").attr("id",f).addClass("form-control"),h=$("<label/>").attr("for",f).text(a),i=0;i<c.length;i++){var j=$("<option/>").attr("value",c[i]).text(c[i]);g.append(j)}g.val(d),g.on("change",function(){e($(this).val())}),$(b).empty().append(h).append(g).addClass("form-group")},dropDownFilter:function(a,b,d,e){void 0===e&&(e=!1);var f="ddf"+this.objectId++,g=$("<select/>").attr("id",f).addClass("form-control"),h=$("<label/>").attr("for",f).text(a),i=$("<option/>").attr("value","").text("Not filtered");g.append(i);for(var j=d[0].group().all(),k=0;k<j.length;k++){var l=$("<option/>").attr("value",j[k].value).text(j[k].key);g.append(l)}g.on("change",function(){for(var a=$(this),b=a.find(":selected").text(),f=a.val(),g=0;g<d.length;g++)""===f?d[g].filterAll():e===!1?d[g].filter(f):d[g].filter(b);c.redrawAll()}),$(b).empty().append(h).append(g).addClass("form-group")},getReduceInitialCountUnique:function(){return{occurrences:[],count:0,sum:0}},getReduceAddCountUnique:function(a,b){return function(c,d){return c.occurrences.indexOf(d[b])!==-1&&(c.occurences.push(d[b]),c.count++,c.sum+=d[a]),c}},getReduceRemoveCountUnique:function(a,b){return function(c,d){var e=c.occurrences.indexOf(d[b]);return e!==-1&&(c.occurences.splice(e,1),c.count--,c.sum-=d[a]),c}},reduceCountUnique:function(a,b,c){return a.reduce(this.getReduceAddCountUnique(b,c),this.getReduceRemoveCountUnique(b,c),this.getReduceInitialCountUnique)},getReduceInitialAvg:function(){return{count:0,sum:0,avg:0}},getReduceInitialSum:function(){return 0},getReduceAddSum:function(a){return function(b,c){return b+=+c[a]}},getReduceRemoveSum:function(a){return function(b,c){return b-=+c[a]}},getReduceInitialAvgFunc:function(a){return void 0===a&&(a=function(){return!0}),function(){return{includeIfTrue:a,count:0,sum:0,avg:0}}},getReduceAddAvg:function(a){return function(b,c){return void 0!==b.includeIfTrue&&!b.includeIfTrue(c)||isNaN(c[a])||(++b.count,b.sum+=c[a]),b.avg=0===b.sum?0:b.sum/b.count,b}},getReduceRemoveAvg:function(a){return function(b,c){return void 0!==b.includeIfTrue&&!b.includeIfTrue(c)||isNaN(c[a])||(--b.count,b.sum-=c[a]),b.avg=0===b.sum?0:b.sum/b.count,b}},reduceAvg:function(a,b){return a.reduce(this.getReduceAddAvg(b),this.getReduceRemoveAvg(b),this.getReduceInitialAvg)},referenceLine:function(b,c,d,e){b.on("renderlet",function(b){var f=[{x:0,y:b.y()(c)},{x:b.width()-b.margins().left-b.margins().right,y:b.y()(c)}],g=a.svg.line().x(function(a){return a.x}).y(function(a){return a.y}).interpolate("linear"),h=b.select("g.chart-body");h.selectAll("path.extra").data([f]).enter().append("path").attr({class:"refline",stroke:"#000","stroke-width":"1px","shape-rendering":"crispEdges"}).attr("d",g),d&&h.selectAll("text.extra-label").data([d]).enter().append("text").attr({class:"refline-label",x:"start"===e?0:b.width()-b.margins().left-b.margins().right,y:b.y()(c)}).style({"text-anchor":e||"end",startOffset:"50%"}).text(d)})},areaChartWeeks:function(a,b,c,d,e){return this.areaChartMonths(a,b,c,d,e,1,53)},areaChartMonths:function(a,b,c,d,e){return this.areaChartMonths(a,b,c,d,e,1,12)},areaChartLinear:function(b,d,e,f,g,h,i){void 0===g&&(g=function(a){return a.value}),void 0===h&&(h=1),void 0===i&&(i=12);var j=this.getNormElemSize(b),k=j.w;return c.lineChart(b).transitionDuration(0).width(k).height(Math.round(.75*k)).x(a.scale.linear().domain([1,12])).margins({left:60,top:10,right:10,bottom:20}).renderArea(!0).brushOn(!0).clipPadding(10).yAxisLabel(f).dimension(d).group(e,"Planned").valueAccessor(g).render()},areaChartTime:function(b,d,e,f,g){var h=this.getNormElemSize(b),i=h.w;return c.lineChart(b).transitionDuration(0).width(i).height(Math.round(.75*i)).x(a.scale.linear().domain([1,12])).margins({left:60,top:10,right:10,bottom:20}).renderArea(!0).brushOn(!0).clipPadding(10).yAxisLabel(f).dimension(d).group(e,"Planned").valueAccessor(g).render()},barChartOrdinal:function(a,b,d,e){var f={aspectRatio:.66},g={};$.extend(!0,g,this.options,f,e);var h=this.getNormElemSize(a,g.minHeight),i=h.w,j=h.h,k=c.barChartOrdinal(a);return g.legendWidth=i,g.legendItemWidth=i,e.colors||(g.colors=c.statColorScales.google()),void 0!==g.valueAccessor&&k.valueAccessor(g.valueAccessor),void 0!==g.valueLabelFormat&&k.valueLabelFormat(g.valueLabelFormat),void 0!==g.xAxisLabelFormat&&k.xAxisLabelFormat(g.xAxisLabelFormat),g.chartConfig.xAxisLabelPadding&&(g.margins.bottom+=g.chartConfig.xAxisLabelPadding),g.chartConfig.yAxisLabelPadding&&(g.margins.left+=g.chartConfig.yAxisLabelPadding),k.transitionDuration(0).width(i).height(j).dimension(b).group(d).colors(g.colors).xAxisLabel(g.chartConfig.xAxisLabel).yAxisLabel(g.chartConfig.yAxisLabel).margins(g.margins),$.isFunction(g.ordering)&&k.ordering(g.ordering),$.isFunction(g.seriesSort)&&k.seriesSort(g.seriesSort),k.legendables=function(){return d.map(function(a){return{name:a.key[0],color:g.colors(a.key[0]),chart:k}})},g.legend&&c.statLegend.legend(k,g),k.render(),null!=g.chartConfig.yAxisLabelAngle&&null!=g.chartConfig.yAxisLabelOffsetX&&null!=g.chartConfig.yAxisLabelOffsetY&&k.selectAll("g.axis.y g.tick text").attr("transform","translate("+this.scaleWidth(i,g.chartConfig.yAxisLabelOffsetX)+","+this.scaleHeight(j,g.chartConfig.yAxisLabelOffsetY)+") rotate("+g.chartConfig.yAxisLabelAngle+")"),null!=g.chartConfig.xAxisLabelAngle&&null!=g.chartConfig.xAxisLabelOffsetX&&null!=g.chartConfig.xAxisLabelOffsetY&&k.selectAll("g.axis.x g.tick text").attr("transform","translate("+this.scaleWidth(i,g.chartConfig.xAxisLabelOffsetX)+","+this.scaleHeight(j,g.chartConfig.xAxisLabelOffsetY)+") rotate("+g.chartConfig.xAxisLabelAngle+")").style("text-anchor","end"),k},dropdownFilterYear:function(a,b,c,d,e){for(var f="ddf"+this.objectId++,g=$("<select/>").attr("id",f).addClass("form-control"),h=$("<label/>").attr("for",f).text("Filter by year"),i=b;i<=c;i++){var j=$("<option/>").attr("value",i).text(i);g.append(j)}g.on("change",function(){var a=$(this),b=a.val();e(b)}),$(a).append(h).append(g).addClass("form-group")},numberDisplay:function(b,d,e){var f={valueAccessor:function(a){return void 0!==a?a.value:null},html:{one:"%number",some:"%number",none:"-"},formatNumber:a.format("0.000")};void 0!==e&&$.extend(f,e);var g=c.numberDisplay(b).group(d).html(f.html).valueAccessor(f.valueAccessor).formatNumber(f.formatNumber);return g.render()},seriesLineChart:function(b,d,e,f){var g={aspectRatio:1,yAxisTickFormat:a.format("d"),childOptions:{xyTipsOn:!0,renderDataPoints:{}}},h={};$.extend(!0,h,this.options,g,f);var i=this.getNormElemSize(b),j=i.w,k=i.h,l=h.chartConfig.refLine,m=h.chartConfig.refLineText,n=h.chartConfig.refLineAllign;h.legendItemWidth=j,h.legendWidth=j;var o=c.seriesChart(b);h.chartConfig.xAxisLabelPadding&&(h.margins.bottom+=h.chartConfig.xAxisLabelPadding),h.chartConfig.yAxisLabelPadding&&(h.margins.left+=h.chartConfig.yAxisLabelPadding),o.transitionDuration(0).width(j).height(k).colors(c.statColorScales.google()).x(h.x).xUnits(h.xUnits).brushOn(!1).yAxisPadding(-1).yAxisLabel(h.chartConfig.xAxisLabel).xAxisLabel(h.chartConfig.yAxisLabel).clipPadding(10)._rangeBandPadding(1).dimension(d).margins(h.margins).group(e).mouseZoomable(!1).seriesAccessor(h.seriesAccessor).keyAccessor(h.keyAccessor).valueAccessor(h.valueAccessor),(l||0===l)&&this.referenceLine(o,l,m,n);var p=h.chartConfig.yAxisMaxValue,q=h.chartConfig.yAxisMinValue||0;return d.filter(function(a){void 0===p&&(p=a[2]),void 0===q&&(q=a[2]),p=a[2]>p?a[2]:p,q=a[2]<q?a[2]:q}),o.y(a.scale.linear().domain([q,p])),h.ordering&&o.ordering(h.ordering),h.valueSort&&o.valueSort(h.valueSort),h.childOptions&&o.childOptions(h.childOptions),void 0!==h.yAxisTickFormat&&o.yAxis().tickFormat(h.yAxisTickFormat),void 0!==h.seriesSort&&o.seriesSort(h.seriesSort),h.legend&&(o.render(),o.legendables=function(){var a,b=[],c=o.children();for(a=0;a<c.length;a++){var d=c[a];o.shareColors()&&d.colors(o.colors()),d.stack().every(function(a){b.push(d.legendables()[0])})}return b},c.statLegend.legend(o,h)),o.render(),null!=h.chartConfig.yAxisLabelAngle&&null!=h.chartConfig.yAxisLabelOffsetX&&null!=h.chartConfig.yAxisLabelOffsetY&&o.selectAll("g.axis.y g.tick text").attr("transform","translate("+this.scaleWidth(j,h.chartConfig.yAxisLabelOffsetX)+","+this.scaleHeight(k,h.chartConfig.yAxisLabelOffsetY)+") rotate("+h.chartConfig.yAxisLabelAngle+")"),null!=h.chartConfig.xAxisLabelAngle&&null!=h.chartConfig.xAxisLabelOffsetX&&null!=h.chartConfig.xAxisLabelOffsetY&&o.selectAll("g.axis.x g.tick text").attr("transform","translate("+this.scaleWidth(j,h.chartConfig.xAxisLabelOffsetX)+","+this.scaleHeight(k,h.chartConfig.xAxisLabelOffsetY)+") rotate("+h.chartConfig.xAxisLabelAngle+")").style("text-anchor","end"),o.getOptions=function(){return h},o.getWidth=function(){return j},o.getHeight=function(){return k},o},currencyFormat:a.format("0.000"),sizeIt:function(a,b,c,d){void 0===c&&console.debug("Missing parameter minHeight for this.sizeIt function"),void 0===d&&console.debug("Missing parameter maxHeightFract for this.sizeIt function");var e=$(window).height();return b>e*d&&(b=e*d),b<c&&(b=c),{w:a,h:b}},getNormElemSize:function(a,b,c){void 0===c&&(c=.33),void 0===b&&(b=250);var d=$(a);return{w:d.parent().width(),h:d.parent().height()}},gaugeChart:function(a,b,d){var e={minHeight:150,maxHeightFract:.25,aspectRatio:.66,unitType:"",dataValueFormat:",.2f",range:[80,100]},f={};$.extend(!0,f,this.options,e,d);var g=this.getNormElemSize(a,f.minHeight,f.maxHeightFract),h=g.w,i=g.h;h>i?h=i:i=h;var j=c.gaugeChart(a);return void 0!==f.valueAccessor&&j.valueAccessor(d.valueAccessor),void 0!==f.dataValueFormat&&j.dataValueFormat(f.dataValueFormat),void 0!==f.unitType&&j.unitType(f.unitType),j.transitionDuration(0).group(b).width(h).height(i).range(f.range),j.render()},rowChart:function(a,b,d,e){var f={aspectRatio:.66},g={};$.extend(!0,g,this.options,f,e);var h=this.getNormElemSize(a,g.minHeight),i=h.w,j=h.h,k=c.rowChart(a);return void 0!==g.valueAccessor&&k.valueAccessor(g.valueAccessor),void 0!==g.valueLabelFormat&&k.valueLabelFormat(g.valueLabelFormat),void 0!==g.xAxisLabelFormat&&k.xAxisLabelFormat(g.xAxisLabelFormat),k.transitionDuration(0).width(i).height(j).dimension(b).group(d).xAxisLabel(g.xAxisLabel).yAxisLabel(g.yAxisLabel).margins(g.margins),$.isFunction(g.ordering)&&k.ordering(g.ordering),$.isFunction(g.seriesSort)&&k.seriesSort(g.seriesSort),k.render()},groupedStackedRowChart:function(a,b,d,e){var f={aspectRatio:.66},g={};$.extend(!0,g,this.options,f,e);var h=this.getNormElemSize(a,g.minHeight),i=h.w,j=h.h,k=c.groupedStackedRowChart(a);return g.legendWidth=i,g.legendItemWidth=i,e.colors||(g.colors=c.statColorScales.google()),void 0!==g.valueAccessor&&k.valueAccessor(g.valueAccessor),void 0!==g.valueLabelFormat&&k.valueLabelFormat(g.valueLabelFormat),void 0!==g.xAxisLabelFormat&&k.xAxisLabelFormat(g.xAxisLabelFormat),g.chartConfig.xAxisLabelPadding&&(g.margins.bottom+=g.chartConfig.xAxisLabelPadding),g.chartConfig.yAxisLabelPadding&&(g.margins.left+=g.chartConfig.yAxisLabelPadding),k.transitionDuration(0).width(i).height(j).dimension(b).group(d).colors(g.colors).xAxisLabel(g.chartConfig.xAxisLabel).yAxisLabel(g.chartConfig.yAxisLabel).margins(g.margins),$.isFunction(g.ordering)&&k.ordering(g.ordering),$.isFunction(g.seriesSort)&&k.seriesSort(g.seriesSort),k.legendables=function(){return d.map(function(a){return{name:a.key[0],color:g.colors(a.key[0]),chart:k}})},g.legend&&c.statLegend.legend(k,g),k.render(),null!=g.chartConfig.yAxisLabelAngle&&null!=g.chartConfig.yAxisLabelOffsetX&&null!=g.chartConfig.yAxisLabelOffsetY&&k.selectAll("g.axis.y g.tick text").attr("transform","translate("+this.scaleWidth(i,g.chartConfig.yAxisLabelOffsetX)+","+this.scaleHeight(j,g.chartConfig.yAxisLabelOffsetY)+") rotate("+g.chartConfig.yAxisLabelAngle+")"),null!=g.chartConfig.xAxisLabelAngle&&null!=g.chartConfig.xAxisLabelOffsetX&&null!=g.chartConfig.xAxisLabelOffsetY&&k.selectAll("g.axis.x g.tick text").attr("transform","translate("+this.scaleWidth(i,g.chartConfig.xAxisLabelOffsetX)+","+this.scaleHeight(j,g.chartConfig.xAxisLabelOffsetY)+") rotate("+g.chartConfig.xAxisLabelAngle+")").style("text-anchor","end"),k},groupedRowChart:function(a,b,d,e){var f={minHeight:300,aspectRatio:.66},g={colors:c.statColorScales.google(),highlightVariables:[],highlightColor:"#ff0000"};$.extend(!0,g,this.options,f,e);var h=this.getNormElemSize(a,g.minHeight),i=h.w,j=h.h;g.legendWidth=i,g.legendItemWidth=j;var k=c.groupedRowChart(a);return void 0!==g.valueAccessor&&k.valueAccessor(g.valueAccessor),void 0!==g.valueLabelFormat&&k.valueLabelFormat(g.valueLabelFormat),void 0!==g.xAxisLabelFormat&&k.xAxisLabelFormat(g.xAxisLabelFormat),g.chartConfig.xAxisLabelPadding&&(g.margins.bottom+=g.chartConfig.xAxisLabelPadding),g.chartConfig.yAxisLabelPadding&&(g.margins.left+=g.chartConfig.yAxisLabelPadding),k.transitionDuration(0).width(i).height(j).dimension(b).group(d).yAxisMinValue(g.chartConfig.yAxisMinValue).yAxisMaxValue(g.chartConfig.yAxisMaxValue).xAxisLabel(g.chartConfig.xAxisLabel).yAxisLabel(g.chartConfig.yAxisLabel).margins(g.margins).colors(g.colors).highlightColor(g.highlightColor).highlightVariables(g.highlightVariables).renderTitle(!0),k.sortArray=g.sortArray,$.isFunction(g.ordering)&&k.ordering(g.ordering),$.isFunction(g.seriesSort)&&k.seriesSort(g.seriesSort),g.legend&&(k.legendables=function(){var a,b=[],c=k.children();for(a=0;a<c.length;a++){var d=c[a];k.shareColors()&&d.colors(k.colors());var e=d.stack().values().next().value.values[0].data.key[4];b[e-1]=d.legendables()[0]}return b},c.statLegend.legend(k,g,!0)),k.render(),null!=g.chartConfig.yAxisLabelAngle&&null!=g.chartConfig.yAxisLabelOffsetX&&null!=g.chartConfig.yAxisLabelOffsetY&&k.selectAll("g.axis.y g.tick text").attr("transform","translate("+this.scaleWidth(i,g.chartConfig.yAxisLabelOffsetX)+","+this.scaleHeight(j,g.chartConfig.yAxisLabelOffsetY)+") rotate("+g.chartConfig.yAxisLabelAngle+")"),null!=g.chartConfig.xAxisLabelAngle&&null!=g.chartConfig.xAxisLabelOffsetX&&null!=g.chartConfig.xAxisLabelOffsetY&&k.selectAll("g.axis.x g.tick text").attr("transform","translate("+this.scaleWidth(i,g.chartConfig.xAxisLabelOffsetX)+","+this.scaleHeight(j,g.chartConfig.xAxisLabelOffsetY)+") rotate("+g.chartConfig.xAxisLabelAngle+")").style("text-anchor","end"),k},stackedBarChart:function(b,d,e,f){var g={minHeight:300,aspectRatio:.66,yAxisTickFormat:a.format("d")},h={};$.extend(!0,h,this.options,g,f);var i=this.getNormElemSize(b,h.minHeight),j=i.w,k=i.h,l=c.stackedBarChart(b);return void 0!==h.valueAccessor&&l.valueAccessor(h.valueAccessor),l.transitionDuration(0).width(j).height(k).dimension(d).group(e).xAxisLabel(h.xAxisLabel).yAxisLabel(h.yAxisLabel).margins(h.margins),void 0!==h.yAxisTickFormat&&l.yAxisLabelFormat(h.yAxisTickFormat),$.isFunction(h.ordering)&&l.ordering(h.ordering),$.isFunction(h.seriesSort)&&l.seriesSort(h.seriesSort),h.legend&&console.log("Render legends to legendDiv"),l.render()},groupedBarChart:function(b,d,e,f){var g={aspectRatio:.66,xAxisTitle:"",yAxisTitle:"",yAxisTickFormat:a.format("d"),legend:!1,autoItemWidth:!1,legendItemHeight:15,legendGap:5,colors:c.statColorScales.google(),horizontalLegend:!0,highlightVariables:[],highlightColor:"#ff0000"},h={};$.extend(!0,h,this.options,g,f);var i=this.getNormElemSize(b,h.minHeight),j=i.w,k=i.h;h.legendWidth=j,h.legendItemWidth=j;var l=h.chartConfig.refLine,m=h.chartConfig.refLineText,n=h.chartConfig.refLineAllign,o=c.groupedBarChart(b);return void 0!==h.valueAccessor&&o.valueAccessor(h.valueAccessor),h.chartConfig.xAxisLabelPadding&&(h.margins.bottom+=h.chartConfig.xAxisLabelPadding),h.chartConfig.yAxisLabelPadding&&(h.margins.left+=h.chartConfig.yAxisLabelPadding),o.transitionDuration(0).width(j).height(k).dimension(d).group(e).xAxisLabel(h.chartConfig.xAxisLabel).yAxisLabel(h.chartConfig.yAxisLabel).yAxisMinValue(h.chartConfig.yAxisMinValue).yAxisMaxValue(h.chartConfig.yAxisMaxValue).margins(h.margins).colors(h.colors).highlightColor(h.highlightColor).highlightVariables(h.highlightVariables),l&&this.referenceLine(o,l,m,n),void 0!==h.yAxisTickFormat&&o.yAxisLabelFormat(h.yAxisTickFormat),$.isFunction(h.ordering)&&o.ordering(h.ordering),$.isFunction(h.seriesSort)&&o.seriesSort(h.seriesSort),h.legend&&c.statLegend.legend(o,h,!0),o.sortArray=h.sortArray,o.render(),null!=h.chartConfig.yAxisLabelAngle&&null!=h.chartConfig.yAxisLabelOffsetX&&null!=h.chartConfig.yAxisLabelOffsetY&&o.selectAll("g.axis.y g.tick text").attr("transform","translate("+this.scaleWidth(j,h.chartConfig.yAxisLabelOffsetX)+","+this.scaleHeight(k,h.chartConfig.yAxisLabelOffsetY)+") rotate("+h.chartConfig.yAxisLabelAngle+")"),null!=h.chartConfig.xAxisLabelAngle&&null!=h.chartConfig.xAxisLabelOffsetX&&null!=h.chartConfig.xAxisLabelOffsetY&&o.selectAll("g.axis.x g.tick text").attr("transform","translate("+this.scaleWidth(j,h.chartConfig.xAxisLabelOffsetX)+","+this.scaleHeight(k,h.chartConfig.xAxisLabelOffsetY)+") rotate("+h.chartConfig.xAxisLabelAngle+")").style("text-anchor","end"),o},pieChart:function(a,b,d,e){var f=this.getNormElemSize(a),g=f.w,h=f.h,i=Math.min(g,h)/2,j={labelAccessor:function(a){return a.value},legend:!1,legendLines:1,legendItemWidth:g,autoItemWidth:!0,legendWidth:g,externalRadiusPadding:50,innerRadius:25,horizontalLegend:!0,legendGap:5,legendItemHeight:15},k={};$.extend(!0,k,this.options,j,e);var l=c.pieChart(a).transitionDuration(0).radius(i).width(g).colors(c.statColorScales.google()).slicesCap(8).innerRadius(k.innerRadius).externalRadiusPadding(k.externalRadiusPadding).drawPaths(!0).dimension(b).renderLabel(!0).label(k.labelAccessor).valueAccessor(k.valueAccessor).group(d);return void 0!==k.ordering&&l.ordering(k.ordering),l.legendHighlight=function(){},l.data(function(a){var b=a.all();return b=b.sort(function(a,b){var c=l.ordering()(a),d=l.ordering()(b);return c>d?1:c<d?-1:0})}),k.legend&&(l.legendables=function(){var a,b=d.all().slice(),c=[];for(a=0;a<b.length;a++){var e=b[a];c[e.key[1]-1]={name:e.key[0],color:k.colors(e.key[0]),chart:l}}return c},c.statLegend.pieLegend(l,k)),l.render()}},c.abstractBubbleChart=c.bubbleMixin,c.baseChart=c.baseMixin,c.capped=c.capMixin,c.colorChart=c.colorMixin,c.coordinateGridChart=c.coordinateGridMixin,c.marginable=c.marginMixin,c.stackableChart=c.stackMixin,c.d3=a,c.crossfilter=b,c}if("function"==typeof define&&define.amd)define(["d3","crossfilter2"],a);else if("object"==typeof module&&module.exports){var b=require("d3"),c=require("crossfilter2");"function"!=typeof c&&(c=c.crossfilter),module.exports=a(b,c)}else this.dc=a(d3,crossfilter)}();
